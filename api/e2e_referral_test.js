...
async function run() {
  ...
  const pay1 = await httpRequest('POST', '/api/verifyUPIPayment', {
    ...
    upiId: 'jayarajj-3@okicici', paymentDate: todayStr(), screenshotUrl: 'https://example.com/ss1.png',
  });
  ...
  const pay2 = await httpRequest('POST', '/api/verifyUPIPayment', {
    ...
    upiId: 'jayarajj-3@okicici', paymentDate: todayStr(), screenshotUrl: 'https://example.com/ss2.png',
  });
